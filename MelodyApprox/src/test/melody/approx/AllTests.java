...
import test.melody.approx.bio.SimpleMutationTest;
...
@SuiteClasses({ PitchContourTest.class, FrequencyContourTest.class, MidiContourTest.class, MelodiaReaderTest.class,
		...
		LegendreInitTest.class, SimpleMutationTest.class, SinglePointCrossoverTest.class, MelodyProcessorTest.class,
